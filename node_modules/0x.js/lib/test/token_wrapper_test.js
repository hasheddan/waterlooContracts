...
describe('TokenWrapper', function () {
    ...
    describe('#transferAsync', function () {
        ...
        it('should successfully transfer tokens', function () { return __awaiter(_this, void 0, void 0, function () {
            var fromAddress, toAddress, preBalance, txHash, postBalance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should throw a CONTRACT_DOES_NOT_EXIST error for a non-existent token contract', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                fromAddress = coinbase;
                toAddress = coinbase;
                return [2 /*return*/, expect(zeroEx.token.transferAsync(nonExistentTokenAddress, fromAddress, toAddress, transferAmount)).to.be.rejectedWith(src_1.ZeroExError.ContractDoesNotExist)];
            });
        }); });
    });
    describe('#transferFromAsync', function () {
        ...
        it('should throw a CONTRACT_DOES_NOT_EXIST error for a non-existent token contract', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                fromAddress = coinbase;
                nonExistentTokenAddress = '0x9dd402f14d67e001d8efbe6583e51bf9706aa065';
                return [2 /*return*/, expect(zeroEx.token.transferFromAsync(nonExistentTokenAddress, fromAddress, toAddress, senderAddress, new BigNumber(42))).to.be.rejectedWith(src_1.ZeroExError.ContractDoesNotExist)];
            });
        }); });
    });
            ...
            it('should return the balance for an existing ERC20 token', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            balance = _a.sent();
                            expectedBalance = new BigNumber('100000000000000000000000000');
            ...
            it('should throw a CONTRACT_DOES_NOT_EXIST error for a non-existent token contract', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, expect(zeroEx.token.getBalanceAsync(nonExistentTokenAddress, ownerAddress))
                            .to.be.rejectedWith(src_1.ZeroExError.ContractDoesNotExist)];
                });
            }); });
            it('should return a balance of 0 for a non-existent owner address', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            balance = _a.sent();
                            expectedBalance = new BigNumber(0);
                            return [2 /*return*/, expect(balance).to.be.bignumber.equal(expectedBalance)];
                    }
                });
            }); });
        ...
        describe('With web3 provider without accounts', function () {
            ...
            before(function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    zeroExWithoutAccounts = new src_1.ZeroEx(web3WithoutAccounts.currentProvider);
                    return [2 /*return*/];
                });
            }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expectedAllowanceBeforeAllowanceSet = new BigNumber(0);
                        expect(allowanceBeforeSet).to.be.bignumber.equal(expectedAllowanceBeforeAllowanceSet);
                        amountInBaseUnits = new BigNumber(50);
        ...
        it('should reduce the gas cost for transfers including tokens with unlimited allowance support', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, promisify(web3.eth.getBalance)(userWithNormalAllowance)];
                    case 3:
                        initBalanceWithNormalAllowance = _a.sent();
                        return [4 /*yield*/, promisify(web3.eth.getBalance)(userWithUnlimitedAllowance)];
                    case 4:
            ...
            it('should return 0 if no allowance set yet', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            allowance = _a.sent();
                            expectedAllowance = new BigNumber(0);
                            return [2 /*return*/, expect(allowance).to.be.bignumber.equal(expectedAllowance)];
                    }
                });
            }); });
    ...
    describe('#subscribe', function () {
        ...
        var tokenAddress;
        var transferAmount = new BigNumber(42);
        var allowanceAmount = new BigNumber(42);
        before(function () {
            var token = tokens[0];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            callbackToBeCalled = function (logEvent) {
                                done();
                            };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = tokens[0];
                        tokenAddress = token.address;
                        return [4 /*yield*/, zeroEx.proxy.getContractAddressAsync()];
                    case 1:
