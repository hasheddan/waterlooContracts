...
describe('ZeroEx library', function () {
    ...
    describe('#generateSalt', function () {
        ...
        it('generates salt in range [0..2^256)', function () {
            ...
            var twoPow256 = new BigNumber(2).pow(256);
    ...
    describe('#toUnitAmount', function () {
        it('Should return the expected unit amount for the decimals passed in', function () {
            var baseUnitAmount = new BigNumber(1000000000);
            var decimals = 6;
            var unitAmount = src_1.ZeroEx.toUnitAmount(baseUnitAmount, decimals);
            var expectedUnitAmount = new BigNumber(1000);
    ...
    describe('#toBaseUnitAmount', function () {
        it('Should return the expected base unit amount for the decimals passed in', function () {
            var unitAmount = new BigNumber(1000);
            var decimals = 6;
            var baseUnitAmount = src_1.ZeroEx.toBaseUnitAmount(unitAmount, decimals);
            var expectedUnitAmount = new BigNumber(1000000000);
    ...
    describe('#config', function () {
        it('allows to specify exchange contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            var config, zeroExWithWrongExchangeAddress;
            return __generator(this, function (_a) {
                config = {
                    exchangeContractAddress: src_1.ZeroEx.NULL_ADDRESS,
                };
                zeroExWithWrongExchangeAddress = new src_1.ZeroEx(web3.currentProvider, config);
                return [2 /*return*/, expect(zeroExWithWrongExchangeAddress.exchange.getContractAddressAsync())
        ...
        it('allows to specify ether token contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            var config, zeroExWithWrongEtherTokenAddress;
            return __generator(this, function (_a) {
                config = {
                    etherTokenContractAddress: src_1.ZeroEx.NULL_ADDRESS,
                };
                zeroExWithWrongEtherTokenAddress = new src_1.ZeroEx(web3.currentProvider, config);
                return [2 /*return*/, expect(zeroExWithWrongEtherTokenAddress.etherToken.getContractAddressAsync())
                        .to.be.rejectedWith(src_1.ZeroExError.ContractDoesNotExist)];
            });
        }); });
        it('allows to specify token registry token contract address', function () { return __awaiter(_this, void 0, void 0, function () {
            var config, zeroExWithWrongTokenRegistryAddress;
            return __generator(this, function (_a) {
                config = {
                    tokenRegistryContractAddress: src_1.ZeroEx.NULL_ADDRESS,
                };
                zeroExWithWrongTokenRegistryAddress = new src_1.ZeroEx(web3.currentProvider, config);
                return [2 /*return*/, expect(zeroExWithWrongTokenRegistryAddress.tokenRegistry.getContractAddressAsync())
                        .to.be.rejectedWith(src_1.ZeroExError.ContractDoesNotExist)];
            });
        }); });
    });
