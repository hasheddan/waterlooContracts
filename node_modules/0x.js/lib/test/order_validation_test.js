        ...
        it('should call exchangeTransferSimulator.transferFrom in a correct order', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        signedOrder = _a.sent();
                        return [4 /*yield*/, orderValidationUtils.validateFillOrderBalancesAllowancesThrowIfInvalidAsync(exchangeTransferSimulator, signedOrder, fillableAmount, takerAddress, zrxTokenAddress)];
                    case 2:
                        _a.sent();
