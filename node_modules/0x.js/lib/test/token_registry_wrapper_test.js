    ...
    describe('#getTokensAsync', function () {
        it('should return all the tokens added to the tokenRegistry during the migration', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                schemaValidator = new _0x_json_schemas_1.SchemaValidator();
                _.each(tokens, function (token) {
                    var validationResult = schemaValidator.validate(token, _0x_json_schemas_1.schemas.tokenSchema);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _.each(tokenAddresses, function (tokenAddress) {
                            var validationResult = schemaValidator.validate(tokenAddress, _0x_json_schemas_1.schemas.addressSchema);
                            expect(validationResult.errors).to.have.lengthOf(0);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        schemaValidator = new _0x_json_schemas_1.SchemaValidator();
                        validationResult = schemaValidator.validate(token, _0x_json_schemas_1.schemas.tokenSchema);
                        expect(validationResult.errors).to.have.lengthOf(0);
                        return [2 /*return*/];
                }
            });
