...
describe('ExchangeWrapper', function () {
    ...
    describe('fillOrKill order(s)', function () {
        ...
        describe('#batchFillOrKillAsync', function () {
            it('successfuly batch fillOrKill', function () { return __awaiter(_this, void 0, void 0, function () {
                var fillableAmount, partialFillTakerAmount, signedOrder, anotherSignedOrder, orderFillOrKillRequests;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fillableAmount = new BigNumber(5);
                            partialFillTakerAmount = new BigNumber(2);
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, zeroEx.exchange.batchFillOrKillAsync(orderFillOrKillRequests, takerAddress)];
                        case 3:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            describe('order transaction options', function () {
                ...
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, expect(zeroEx.exchange.batchFillOrKillAsync(orderFillOrKillRequests, takerAddress))
        ...
        describe('#fillOrKillOrderAsync', function () {
            ...
            describe('successful fills', function () {
                        ...
                        switch (_j.label) {
                            ...
                            case 4:
                                _d.apply(void 0, [_j.sent()])
                                    .to.be.bignumber.equal(fillableAmount);
                                return [4 /*yield*/, zeroEx.exchange.fillOrKillOrderAsync(signedOrder, fillTakerAmount, takerAddress)];
                            case 5:
                                _j.sent();
                                _e = expect;
                                return [4 /*yield*/, zeroEx.token.getBalanceAsync(makerTokenAddress, makerAddress)];
                ...
                it('should partially fill a valid order', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_e) {
                        switch (_e.label) {
                            case 0:
                                partialFillAmount = new BigNumber(3);
            ...
            describe('order transaction options', function () {
                var emptyFillableAmount = new BigNumber(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
    ...
    describe('fill order(s)', function () {
        ...
        describe('#fillOrderAsync', function () {
                    ...
                    return __generator(this, function (_j) {
                        switch (_j.label) {
                            ...
                            case 5:
                                _d.apply(void 0, [_j.sent()])
                                    .to.be.bignumber.equal(fillableAmount);
                                return [4 /*yield*/, zeroEx.exchange.fillOrderAsync(signedOrder, fillTakerAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)];
                            case 6:
                                txHash = _j.sent();
            ...
            describe('order transaction options', function () {
                var signedOrder;
                var emptyFillTakerAmount = new BigNumber(0);
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, fillScenarios.createFillableSignedOrderAsync(makerTokenAddress, takerTokenAddress, makerAddress, takerAddress, fillableAmount)];
        ...
        describe('#batchFillOrdersAsync', function () {
            ...
            describe('order transaction options', function () {
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        emptyFillTakerAmount = new BigNumber(0);
                        orderFillBatch = [
                            {
                                signedOrder: signedOrder,
        ...
        describe('#fillOrdersUpTo', function () {
            ...
            describe('order transaction options', function () {
                var emptyFillUpToAmount = new BigNumber(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
    ...
    describe('cancel order(s)', function () {
        ...
        describe('#cancelOrderAsync', function () {
                ...
                it('should cancel an order', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                _a.sent();
                                return [4 /*yield*/, zeroEx.exchange.getCanceledTakerAmountAsync(orderHashHex)];
                            case 3:
            ...
            describe('order transaction options', function () {
                var emptyCancelTakerTokenAmount = new BigNumber(0);
                it('should validate when orderTransactionOptions are not present', function () { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
        ...
        describe('#batchCancelOrdersAsync', function () {
                ...
                it('should cancel a batch of orders', function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 2:
                                cancelledAmount = _a.sent();
                                return [4 /*yield*/, zeroEx.exchange.getCanceledTakerAmountAsync(anotherOrderHashHex)];
                            case 3:
            ...
            describe('order transaction options', function () {
                beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        emptyTakerTokenCancelAmount = new BigNumber(0);
                        cancelBatch = [
                            {
                                order: signedOrder,
    ...
    describe('tests that require partially filled order', function () {
        ...
        describe('#getCanceledTakerAmountAsync', function () {
            it('should throw if passed an invalid orderHash', function () { return __awaiter(_this, void 0, void 0, function () {
                var invalidOrderHashHex;
                return __generator(this, function (_a) {
                    invalidOrderHashHex = '0x123';
                    return [2 /*return*/, expect(zeroEx.exchange.getCanceledTakerAmountAsync(invalidOrderHashHex)).to.be.rejected()];
                });
            }); });
            it('should return zero if passed a valid but non-existent orderHash', function () { return __awaiter(_this, void 0, void 0, function () {
                var cancelledValueT;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.getCanceledTakerAmountAsync(NON_EXISTENT_ORDER_HASH)];
                        case 1:
            ...
            it('should return the cancelledValueT for a valid and partially filled orderHash', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, zeroEx.exchange.getCanceledTakerAmountAsync(orderHash)];
                        case 1:
                            cancelledValueT = _a.sent();
                            expect(cancelledValueT).to.be.bignumber.equal(0);
                            return [2 /*return*/];
            ...
            it('should return the cancelledValueT for a valid and cancelled orderHash', function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, zeroEx.exchange.getCanceledTakerAmountAsync(orderHash)];
                        case 2:
                            cancelledValueT = _a.sent();
    ...
    describe('#subscribeAsync', function () {
        ...
        var fillableAmount;
        var signedOrder;
        var fillTakerAmountInBaseUnits = new BigNumber(1);
        var cancelTakerAmountInBaseUnits = new BigNumber(1);
        before(function () {
            coinbase = userAddresses[0], makerAddress = userAddresses[1], takerAddress = userAddresses[2];
            var makerToken = tokens[0], takerToken = tokens[1];
            makerTokenAddress = makerToken.address;
        ...
        it('Should receive the LogFill event when an order is filled', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            callback = function (logEvent) {
                                expect(logEvent.event).to.be.equal(src_1.ExchangeEvents.LogFill);
                                done();
                            };
                            return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, indexFilterValues, callback)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, zeroEx.exchange.fillOrderAsync(signedOrder, fillTakerAmountInBaseUnits, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
            ...
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            callback = function (logEvent) {
                                expect(logEvent.event).to.be.equal(src_1.ExchangeEvents.LogCancel);
                                done();
                            };
                            return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogCancel, indexFilterValues, callback)];
                        case 1:
                            _a.sent();
        ...
        it('Outstanding subscriptions are cancelled when zeroEx.setProviderAsync called', function (done) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                var callbackNeverToBeCalled, newProvider, callback;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            callbackNeverToBeCalled = function (logEvent) {
                                done(new Error('Expected this subscription to have been cancelled'));
                            };
                            return [4 /*yield*/, zeroEx.exchange.subscribeAsync(src_1.ExchangeEvents.LogFill, indexFilterValues, callbackNeverToBeCalled)];
                        case 1:
                            _a.sent();
                            newProvider = web3_factory_1.web3Factory.getRpcProvider();
                            return [4 /*yield*/, zeroEx.setProviderAsync(newProvider)];
                        case 2:
                            _a.sent();
                            callback = function (logEvent) {
                                expect(logEvent.event).to.be.equal(src_1.ExchangeEvents.LogFill);
    ...
    describe('#getZRXTokenAddressAsync', function () {
        it('gets the same token as is in token registry', function () { return __awaiter(_this, void 0, void 0, function () {
            var zrxAddress, zrxToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, zeroEx.exchange.getZRXTokenAddressAsync()];
                    case 1:
                        zrxAddress = _a.sent();
                        zrxToken = tokenUtils.getProtocolTokenOrThrow();
    ...
    describe('#getLogsAsync', function () {
        ...
        var subscriptionOpts = {
            fromBlock: types_1.BlockParamLiteral.Earliest,
