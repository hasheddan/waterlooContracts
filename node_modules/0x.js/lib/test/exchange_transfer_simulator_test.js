...
describe('ExchangeTransferSimulator', function () {
    ...
    var transferAmount = new BigNumber(5);
    var userAddresses;
    var tokens;
    var coinbase;
    var sender;
    ...
    describe('#transferFromAsync', function () {
        beforeEach(function () {
            exchangeTransferSimulator = new exchange_transfer_simulator_1.ExchangeTransferSimulator(zeroEx.token);
        });
        ...
        it('updates balances and proxyAllowance after transfer', function () { return __awaiter(_this, void 0, void 0, function () {
            var senderBalance, recipientBalance, senderProxyAllowance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, exchangeTransferSimulator.getBalanceAsync(exampleTokenAddress, sender)];
                    case 6:
                        senderBalance = _a.sent();
                        return [4 /*yield*/, exchangeTransferSimulator.getBalanceAsync(exampleTokenAddress, recipient)];
                    case 7:
                        recipientBalance = _a.sent();
                        return [4 /*yield*/, exchangeTransferSimulator.getProxyAllowanceAsync(exampleTokenAddress, sender)];
                    case 8:
