 ...
 */
var ExchangeWrapper = (function (_super) {
    __extends(ExchangeWrapper, _super);
    function ExchangeWrapper(web3Wrapper, abiDecoder, tokenWrapper, contractAddressIfExists) {
        var _this = _super.call(this, web3Wrapper, abiDecoder) || this;
    ...
    ExchangeWrapper.prototype.getUnavailableTakerAmountAsync = function (orderHash, methodOpts) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('orderHash', orderHash, _0x_json_schemas_1.schemas.orderHashSchema);
     ...
     */
    ExchangeWrapper.prototype.getCanceledTakerAmountAsync = function (orderHash, methodOpts) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ExchangeWrapper.prototype.fillOrderAsync = function (signedOrder, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, shouldValidate, zrxTokenAddress, exchangeTradeEmulator, _a, orderAddresses, orderValues, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('signedOrder', signedOrder, _0x_json_schemas_1.schemas.signedOrderSchema);
                        assert_1.assert.isBigNumber('fillTakerTokenAmount', fillTakerTokenAmount);
                    ...
                    case 2:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            SHOULD_VALIDATE_BY_DEFAULT :
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.getZRXTokenAddressAsync()];
                    case 3:
                        zrxTokenAddress = _b.sent();
                        exchangeTradeEmulator = new exchange_transfer_simulator_1.ExchangeTransferSimulator(this._tokenWrapper);
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, exchangeInstance.fillOrder.estimateGasAsync(orderAddresses, orderValues, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, signedOrder.ecSignature.v, signedOrder.ecSignature.r, signedOrder.ecSignature.s, {
                                from: takerAddress,
                            })];
                    case 6:
                        gas = _b.sent();
    ...
    ExchangeWrapper.prototype.fillOrdersUpToAsync = function (signedOrders, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var takerTokenAddresses, exchangeContractAddresses, shouldValidate, zrxTokenAddress, exchangeTradeEmulator, _i, signedOrders_1, signedOrder, orderAddressesValuesAndSignatureArray, _a, orderAddressesArray, orderValuesArray, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('signedOrders', signedOrders, _0x_json_schemas_1.schemas.signedOrdersSchema);
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3:
                        if (!(_i < signedOrders_1.length)) return [3 /*break*/, 6];
                    ...
                    case 7:
                        exchangeInstance = _b.sent();
                        return [4 /*yield*/, exchangeInstance.fillOrdersUpTo.estimateGasAsync(orderAddressesArray, orderValuesArray, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, vArray, rArray, sArray, {
                                from: takerAddress,
                            })];
                    case 8:
                        gas = _b.sent();
    ...
    ExchangeWrapper.prototype.batchFillOrdersAsync = function (orderFillRequests, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, shouldValidate, zrxTokenAddress, exchangeTradeEmulator, _i, orderFillRequests_1, orderFillRequest, orderAddressesValuesAmountsAndSignatureArray, _a, orderAddressesArray, orderValuesArray, fillTakerTokenAmounts, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('orderFillRequests', orderFillRequests, _0x_json_schemas_1.schemas.orderFillRequestsSchema);
                    ...
                    case 7:
                        exchangeInstance = _b.sent();
                        return [4 /*yield*/, exchangeInstance.batchFillOrders.estimateGasAsync(orderAddressesArray, orderValuesArray, fillTakerTokenAmounts, shouldThrowOnInsufficientBalanceOrAllowance, vArray, rArray, sArray, {
                                from: takerAddress,
                            })];
                    case 8:
                        gas = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        _a = ExchangeWrapper._getOrderAddressesAndValues(signedOrder), orderAddresses = _a[0], orderValues = _a[1];
                        return [4 /*yield*/, exchangeInstance.fillOrKillOrder.estimateGasAsync(orderAddresses, orderValues, fillTakerTokenAmount, signedOrder.ecSignature.v, signedOrder.ecSignature.r, signedOrder.ecSignature.s, {
                                from: takerAddress,
                            })];
                    case 6:
                        gas = _b.sent();
     ...
     * @return  Transaction hash.
     */
    ExchangeWrapper.prototype.batchFillOrKillAsync = function (orderFillOrKillRequests, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, exchangeInstance, shouldValidate, zrxTokenAddress, exchangeTradeEmulator, _i, orderFillOrKillRequests_1, orderFillOrKillRequest, orderAddressesValuesAndTakerTokenFillAmounts, _a, orderAddresses, orderValues, fillTakerTokenAmounts, vParams, rParams, sParams, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('orderFillOrKillRequests', orderFillOrKillRequests, _0x_json_schemas_1.schemas.orderFillOrKillRequestsSchema);
                        exchangeContractAddresses = _.map(orderFillOrKillRequests, function (orderFillOrKillRequest) { return orderFillOrKillRequest.signedOrder.exchangeContractAddress; });
                        assert_1.assert.hasAtMostOneUniqueValue(exchangeContractAddresses, types_1.ExchangeContractErrs.BatchOrdersMustHaveSameExchangeAddress);
                        return [4 /*yield*/, assert_1.assert.isSenderAddressAsync('takerAddress', takerAddress, this._web3Wrapper)];
                    case 1:
                        _b.sent();
                    ...
                    case 2:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            SHOULD_VALIDATE_BY_DEFAULT :
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.getZRXTokenAddressAsync()];
                    case 3:
                        zrxTokenAddress = _b.sent();
                        exchangeTradeEmulator = new exchange_transfer_simulator_1.ExchangeTransferSimulator(this._tokenWrapper);
                        _i = 0, orderFillOrKillRequests_1 = orderFillOrKillRequests;
                        _b.label = 4;
                    case 4:
                        if (!(_i < orderFillOrKillRequests_1.length)) return [3 /*break*/, 7];
                        orderFillOrKillRequest = orderFillOrKillRequests_1[_i];
                        return [4 /*yield*/, this._orderValidationUtils.validateFillOrKillOrderThrowIfInvalidAsync(exchangeTradeEmulator, orderFillOrKillRequest.signedOrder, orderFillOrKillRequest.fillTakerAmount, takerAddress, zrxTokenAddress)];
                    case 5:
                        _b.sent();
                        _b.label = 6;
                    case 6:
                        ...
                        return [3 /*break*/, 4];
                    case 7:
                        orderAddressesValuesAndTakerTokenFillAmounts = _.map(orderFillOrKillRequests, function (request) {
                        ...
                        return [4 /*yield*/, exchangeInstance.batchFillOrKillOrders.estimateGasAsync(orderAddresses, orderValues, fillTakerTokenAmounts, vParams, rParams, sParams, {
                                from: takerAddress,
                            })];
                    case 8:
                        gas = _b.sent();
    ...
    ExchangeWrapper.prototype.cancelOrderAsync = function (order, cancelTakerTokenAmount, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, shouldValidate, orderHash, unavailableTakerTokenAmount, _a, orderAddresses, orderValues, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('order', order, _0x_json_schemas_1.schemas.orderSchema);
                        assert_1.assert.isBigNumber('takerTokenCancelAmount', cancelTakerTokenAmount);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this._orderValidationUtils.validateCancelOrderThrowIfInvalidAsync(order, cancelTakerTokenAmount, unavailableTakerTokenAmount)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
                        _a = ExchangeWrapper._getOrderAddressesAndValues(order), orderAddresses = _a[0], orderValues = _a[1];
                        return [4 /*yield*/, exchangeInstance.cancelOrder.estimateGasAsync(orderAddresses, orderValues, cancelTakerTokenAmount, {
                                from: order.maker,
                            })];
                    case 6:
                        gas = _b.sent();
    ...
    ExchangeWrapper.prototype.batchCancelOrdersAsync = function (orderCancellationRequests, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddresses, makers, maker, shouldValidate, _i, orderCancellationRequests_1, orderCancellationRequest, orderHash, unavailableTakerTokenAmount, exchangeInstance, orderAddressesValuesAndTakerTokenCancelAmounts, _a, orderAddresses, orderValues, cancelTakerTokenAmounts, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('orderCancellationRequests', orderCancellationRequests, _0x_json_schemas_1.schemas.orderCancellationRequestsSchema);
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        if (!(_i < orderCancellationRequests_1.length)) return [3 /*break*/, 6];
                    ...
                    case 3:
                        unavailableTakerTokenAmount = _b.sent();
                        return [4 /*yield*/, this._orderValidationUtils.validateCancelOrderThrowIfInvalidAsync(orderCancellationRequest.order, orderCancellationRequest.takerTokenCancelAmount, unavailableTakerTokenAmount)];
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5:
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, exchangeInstance.batchCancelOrders.estimateGasAsync(orderAddresses, orderValues, cancelTakerTokenAmounts, {
                                from: maker,
                            })];
                    case 8:
                        gas = _b.sent();
     ...
     */
    ExchangeWrapper.prototype.subscribeAsync = function (eventName, indexFilterValues, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeContractAddress, subscriptionToken;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesBelongToStringEnum('eventName', eventName, types_1.ExchangeEvents);
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, _0x_json_schemas_1.schemas.indexFilterValuesSchema);
                        assert_1.assert.isFunction('callback', callback);
                        return [4 /*yield*/, this.getContractAddressAsync()];
                    case 1:
                        exchangeContractAddress = _a.sent();
                        subscriptionToken = this._subscribe(exchangeContractAddress, eventName, indexFilterValues, artifacts_1.artifacts.ExchangeArtifact.abi, callback);
                        this._activeSubscriptions.push(subscriptionToken);
                        return [2 /*return*/, subscriptionToken];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesBelongToStringEnum('eventName', eventName, types_1.ExchangeEvents);
                        assert_1.assert.doesConformToSchema('subscriptionOpts', subscriptionOpts, _0x_json_schemas_1.schemas.subscriptionOptsSchema);
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, _0x_json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this.getContractAddressAsync()];
                    case 1:
                        exchangeContractAddress = _a.sent();
     ...
     */
    ExchangeWrapper.prototype.getContractAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, exchangeAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('order', order, _0x_json_schemas_1.schemas.orderSchema);
                        assert_1.assert.isBigNumber('cancelTakerTokenAmount', cancelTakerTokenAmount);
                        orderHash = utils_1.utils.getOrderHashHex(order);
                        return [4 /*yield*/, this.getUnavailableTakerAmountAsync(orderHash)];
                    case 1:
                        unavailableTakerTokenAmount = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.isBigNumber('makerTokenAmount', makerTokenAmount);
                        return [4 /*yield*/, this._getExchangeContractAsync()];
                    case 1:
                        exchangeInstance = _a.sent();
     ...
     */
    ExchangeWrapper.prototype.getZRXTokenAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, ZRXtokenAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._getExchangeContractAsync()];
                    case 1:
                        exchangeInstance = _a.sent();
                        return [4 /*yield*/, exchangeInstance.ZRX_TOKEN_CONTRACT.callAsync()];
                    case 2:
                        ZRXtokenAddress = _a.sent();
                        return [2 /*return*/, ZRXtokenAddress];
                }
            });
        });
    };
    ...
    ExchangeWrapper.prototype._invalidateContractInstancesAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.unsubscribeAll();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('ecSignature', ecSignature, _0x_json_schemas_1.schemas.ecSignatureSchema);
