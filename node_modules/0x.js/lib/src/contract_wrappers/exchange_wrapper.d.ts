...
import { Order, OrderFillOrKillRequest, SignedOrder, ExchangeEvents, SubscriptionOpts, IndexedFilterValues, OrderCancellationRequest, OrderFillRequest, LogWithDecodedArgs, MethodOpts, ValidateOrderFillableOpts, OrderTransactionOpts, EventCallback, ExchangeContractEventArgs, DecodedLogArgs } from '../types';
...
export declare class ExchangeWrapper extends ContractWrapper {
    ...
    constructor(web3Wrapper: Web3Wrapper, abiDecoder: AbiDecoder, tokenWrapper: TokenWrapper, contractAddressIfExists?: string);
    /**
     ...
     */
    fillOrderAsync(signedOrder: SignedOrder, fillTakerTokenAmount: BigNumber.BigNumber, shouldThrowOnInsufficientBalanceOrAllowance: boolean, takerAddress: string, orderTransactionOpts?: OrderTransactionOpts): Promise<string>;
    /**
     ...
     * @return  Transaction hash.
     */
    fillOrdersUpToAsync(signedOrders: SignedOrder[], fillTakerTokenAmount: BigNumber.BigNumber, shouldThrowOnInsufficientBalanceOrAllowance: boolean, takerAddress: string, orderTransactionOpts?: OrderTransactionOpts): Promise<string>;
    /**
     ...
     * @return  Transaction hash.
     */
    fillOrKillOrderAsync(signedOrder: SignedOrder, fillTakerTokenAmount: BigNumber.BigNumber, takerAddress: string, orderTransactionOpts?: OrderTransactionOpts): Promise<string>;
    /**
     ...
     * @return  Transaction hash.
     */
    batchFillOrKillAsync(orderFillOrKillRequests: OrderFillOrKillRequest[], takerAddress: string, orderTransactionOpts?: OrderTransactionOpts): Promise<string>;
    /**
     ...
     * @return  Transaction hash.
     */
    cancelOrderAsync(order: Order | SignedOrder, cancelTakerTokenAmount: BigNumber.BigNumber, orderTransactionOpts?: OrderTransactionOpts): Promise<string>;
    /**
     ...
     */
    subscribeAsync<ArgsType extends ExchangeContractEventArgs>(eventName: ExchangeEvents, indexFilterValues: IndexedFilterValues, callback: EventCallback<ArgsType>): Promise<string>;
    /**
     ...
     */
    getZRXTokenAddressAsync(): Promise<string>;
    /**
