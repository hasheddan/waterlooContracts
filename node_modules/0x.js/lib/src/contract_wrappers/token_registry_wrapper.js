 ...
 */
var TokenRegistryWrapper = (function (_super) {
    __extends(TokenRegistryWrapper, _super);
    function TokenRegistryWrapper(web3Wrapper, contractAddressIfExists) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        addresses = _a.sent();
                        tokenPromises = _.map(addresses, function (address) { return (_this.getTokenIfExistsAsync(address)); });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        metadata = _a.sent();
                        token = this._createTokenFromMetadata(metadata);
     ...
     */
    TokenRegistryWrapper.prototype.getContractAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var tokenRegistryInstance, tokenRegistryAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._getTokenRegistryContractAsync()];
                    case 1:
                        tokenRegistryInstance = _a.sent();
                        tokenRegistryAddress = tokenRegistryInstance.address;
                        return [2 /*return*/, tokenRegistryAddress];
                }
            });
        });
    };
    TokenRegistryWrapper.prototype._createTokenFromMetadata = function (metadata) {
