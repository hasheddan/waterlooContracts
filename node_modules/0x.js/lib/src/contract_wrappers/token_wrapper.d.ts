...
import { TokenEvents, IndexedFilterValues, SubscriptionOpts, MethodOpts, LogWithDecodedArgs, EventCallback, TokenContractEventArgs } from '../types';
/**
...
export declare class TokenWrapper extends ContractWrapper {
    ...
    constructor(web3Wrapper: Web3Wrapper, abiDecoder: AbiDecoder, tokenTransferProxyContractAddressFetcher: () => Promise<string>);
    /**
