 ...
 */
var TokenTransferProxyWrapper = (function (_super) {
    __extends(TokenTransferProxyWrapper, _super);
    function TokenTransferProxyWrapper(web3Wrapper, tokenTransferProxyContractAddressFetcher) {
        var _this = _super.call(this, web3Wrapper) || this;
        _this._tokenTransferProxyContractAddressFetcher = tokenTransferProxyContractAddressFetcher;
        return _this;
    }
    /**
     ...
     */
    TokenTransferProxyWrapper.prototype.getContractAddressAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var proxyInstance, proxyAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._getTokenTransferProxyContractAsync()];
                    case 1:
                        proxyInstance = _a.sent();
    ...
    TokenTransferProxyWrapper.prototype._getTokenTransferProxyContractAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            var contractAddress, contractInstance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._tokenTransferProxyContractAddressFetcher()];
                    case 1:
                        contractAddress = _a.sent();
                        return [4 /*yield*/, this._instantiateContractIfExistsAsync(artifacts_1.artifacts.TokenTransferProxyArtifact, contractAddress)];
                    case 2:
